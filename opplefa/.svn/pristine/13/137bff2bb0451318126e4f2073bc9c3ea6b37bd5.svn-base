					...
					<form id = "addForm">
						<table border="0" cellspacing="0" cellpadding="0" id="format">
							...
							<tr>
								...
								<td><input name="caddressCode" type="text" class="colorblur require-red" id="caddressCode"/> </td>
							</tr>
							<tr>
								<td class="tdtitle"><span>*</span>办公地点:</td>
								<td><input name="caddressName" type="text" class="colorblur require-red" id="caddressName"/></td>
							</tr>
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" name="receivegoodsCode" id="receivegoodsCode" class="code"/>
									<input type="text" name="receivegoodsName" id="receivegoodsName" class="colorblur name require-red" readonly="readonly" style="width: 160px;"><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showUserListBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;"></td>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="hidden" name="retiredgoodsCode" id="retiredgoodsCode" class="code"/>
									<input type="text" name="retiredgoodsName" id="retiredgoodsName" class="colorblur name require-red" readonly="readonly" style="width: 160px;"><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showUserListBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;"></td>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="hidden" name="purchasetipaccessCode" id="purchasetipaccessCode" class="code"/>
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" name="purchasebidCode" id="purchasebidCode" class="code"/>
									<input type="text" name="purchasebidName" id="purchasebidName" class="colorblur name require-red" readonly="readonly" style="width: 160px;"><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showUserListBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;"></td>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="hidden" name="payeeCode" id="payeeCode" class="code"/>
									<input type="text" name="payeeName" id="payeeName" class="colorblur name require-red" readonly="readonly" style="width: 160px;"><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showUserListBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;"></td>
								</td>
							</tr>
							<tr>
								<td class="tdtitle">数据状态 :</td>
								<td>
									<select index="1" name="cstatus" id="txtCstatus" class="colorblur" style="width: 60px;">
							...
							<tr>
								...
								<td>
									<textarea cols="50" rows="3" name="cmemo" id="cmemo" class="colorblur code"></textarea>
								</td>
							</tr>
							</tbody>
						</table>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#btnSave").click(function(){//保存
			add(this, '${dynamicURL}/config/workAddress/add');
		});
	});
