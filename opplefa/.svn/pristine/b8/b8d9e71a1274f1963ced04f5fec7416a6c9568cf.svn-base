					...
					<tbody>
						<tr>
							...
							<td>
								...
								<input class="searchinput" name="" type="hidden" value="" id="departmentIndex">
							</td>
							<td style="text-align: right; width: 90px;">供应商编码:</td>
							<td>
								<input style="width: 100px;" readonly='readonly' class='searchinput' name='supplierCode' type='text' value='${purchaseOrder.supplierCode}' id='supplierCode'><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanSupp();"><input id="butSupplierShow" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
							</td>
						...
						<tr>
							...
							<td>
								<input readonly='readonly' class='searchinput' name='supplierName' type='text' value='${purchaseOrder.supplierName}' id='supplierName'>
							</td>
							<td style="text-align: right" >汇率:</td>
							<td class="tdtext">
								<input class='searchinput' name='exchangeRate' readonly='readonly' type='text' value='${purchaseOrder.exchangeRate}' id='exchangeRate'></td>
						</tr>
						<tr>
							<td style="text-align: right"><font color="red" >*</font>申请部门:</td>
							<td>
								<span id ="spanBudgetDepartment"><input style="width: 100px;" readonly="readonly" name="departmentName" value="" type="text" id="txtBudgetDepartment" class="inputbtnRefViewGray" ></span><input id='btnRefClear1' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanDep();"><input id="btntxtYsssbmShow" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
								<input name="departmentCode" value="" type="hidden" id="txtYsssbm" class="inputbtnRefViewGray" >
							</td>
							<td style="text-align: right;">公司具体名称:</td>
							<td class="tdtext">
								<input class="searchinput" readonly="readonly" name="companySpecificName" type="text" value="<fmt:formatDate value='${purchaseOrder.companySpecificName}'  pattern='yyyy-MM-dd'/>" id="companySpecificName">
							</td>
							<td style="text-align: right"><font color="red" >*</font>银行账号:</td>
	                        <td class="tdtext" >
								<input readonly="readonly" class="searchinput" style="background-color: #CCCCCC;" name="bankNumber" type="text" value="" id="bankNumber">
							</td>
						</tr>
						<tr> 
							...
							<td>
								<input  class='searchinput' name='country' type='text' value='' id='country'>
							</td>
							<td style="text-align: right; width: 90px;">开户行:</td>
							<td>
								<input readonly='readonly' class='searchinput' name='bankName' type='text' value='${purchaseOrder.bankName}' id='bankName'>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input readonly='readonly' class='searchinput' name='contactNumber' type='text' value='${purchaseOrder.contactNumber}' id='contactNumber'>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input  class='searchinput' name='invoiceNumber' type='text' value='' id='invoiceNumber'>
							</td>
							...
							<td>
								<select class="searchselect" name="insertType" id="insertType">
										<option value="">--请选择--</option>
										<option value="资产新增">资产新增</option>
										<option value="价值新增">价值新增</option>
	                            </select>
							</td>
						</tr>
						<tr>
							<td style="text-align: right" >备注:</td>
							<td class="tdtext"><input  class='searchinput' name='remark' type='text' value='${purchaseOrder.remark}' id='remark'></td>
						</tr>
					</tbody>
					</table>
                </td>
							...
							<td class="tdtitle" style="text-align: right" colspan="2">
								<div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
									<div>
										...
										<!-- 		<th scope="col" class="tdpadding" start="hid"><font color="red" >*</font>主编吗</th>
												<th scope="col" class="tdpadding" start="hid"><font color="red" >*</font>次级</th> --> 
												...
												<th class='tdpadding' scope="col" hid="hid"><font color="red" >*</font>资产分类</th>
												<th class='tdpadding' scope="col" hid="hid"><font color="red" >*</font>折旧年限</th>
												...
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>数量</th>
								<!-- 				<th scope="col" class="tdpadding"><font color="red" >*</font>编码方式</th>
												...
												<!-- 5 -->
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>含税单价</th>
												<th scope="col" class="tdpadding" hid="hid">净价</th>
												<th scope="col" class="tdpadding" ><font color="red" >*</font>可用预算金额</th>
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>含税总价</th>
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>税额</th>
												...
												<!-- 10 -->
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>本次申请金额(原币)</th>
												<!-- 15 -->
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>本次预付冲减金额</th>
												<th scope="col" class="tdpadding" hid="hid"><font color="red" >*</font>尾款金额</th>
												<th scope="col" class="tdpadding" hid="hid">尾款付款时间</th>
												<!-- 20 -->
												<th scope="col" class="tdpadding" hid="hid">本次申请金额(本币)</th>
											</tr>
											<tbody id="table_detail">
											<tr class="bodyTr" style="white-space:nowrap;">
												<td>
			                                        <input id="gvDataList_chkBolDel_0" type="checkbox" name="jvDataList_chkBolDel_0">
			                                    </td>
												<td class="tdpadding" id='statusIndex'>1<input value='${notPoPaymentOrder.cdocument}' type="hidden" name="notPoPaymentOrderId" id="notPoPaymentOrderId"></td>
												<td class='tdpadding'>
                                                    <input style="width: 100px;" readonly="readonly" name="costCenter" value="" type="text" id="costCenterName1" class="inputbtnRefViewGray name"><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="ClearObj(this);"><input id="showCostCenterBtn1" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
                                                    <input type="hidden" id="costCenterCode1" name="costCenterCode" value="" class="code">
                                               	</td>
												<td class="tdpadding">
													<input style="width: 100px;" name="projectCode" type="text" id="projectCode1" style='width:130px;' class="inputbtnRefViewGray" readonly="readonly"><input id="projectCodeClear1" class="btnRefView" onclick="" title="点击清空参照文本框内容" type="button" value="X"><input id="btnRefShow1" class="btnRefView"  title="点击打开参照文本框内容" type="button" value="…">
		                                    		<input name="hdapplydepcode" type="hidden" id="hdapplydepcode">
		                                    	</td>
												<td class='budgetAssetsNameTd' style="padding-left: 10px; padding-right: 10px;"><input size='10' type="text" readonly name="budgetAssetsName" id="txtBudgetAssetsName1"></td>
												
												<td class='tdpadding' ><input style="width: 100px;" class="td_input" name="subordinateDepartment" type="text"
													readonly="readonly"  id="subordinateDepartment1"><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanDep1(this);"><input id="btntxtZcssbmShow1" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
													<input id="subordinateDepartmentCode1" type="hidden" name="subordinateDepartmentCode">
												</td>
												...
												<!-- <td class="tdpadding" start="hid"><input type="text" name="mainAssetCode" size='10' id="mainAssetCode"></td>
												<td class="tdpadding" start="hid"><input type="text" name="secondary" class='rightalign' id="secondary" size='7'></td> -->
												<td class='assetsNameTd' style="padding-left: 10px; padding-right: 10px;"><input type="text"  size='10' name="assetsName" id="txtAssetsName1"></td>
												<td class='tdpadding'>
												...
												<td class='specificationParameterTd' style="padding-left: 10px; padding-right: 10px;"><input size='10' type="text" name="specificationParameter" id="txtSpecificationParameter"></td>
												<td class='tdpadding' hid="hid">
                                                    <input style="width: 100px;" readonly="readonly" name="assetClassification" value="" type="text" id="assetClassification1" class="inputbtnRefViewGray" ></span><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanAssets(this);"><input id="btnAssetsShow1" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
                                                    <input type="hidden" id="netSalvage" name="netSalvage" value="">
                                               	</td>
                                               	<td class='tdpadding' hid="hid" >
                                                        <input disabled="true" id="depreciation1" name="depreciation" value="" size='5'>
                                                </td>
                                                <td class='tdpadding'>
                                                 	<input value=""  readonly="readonly" name="ledgerAccount" id="ledgerAccount1" size='10'>
                                                </td>
                                                <td class='tdpadding'>
                                                 	<input style="width: 100px;" class="inputbtnRefViewGray name" name="assetsUserName" type="text"
													readonly="readonly" value="" id="assetsUserName1"></span><input id='gvdMeeting_btnClearsk_0'  class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="ClearObj(this);"><input id="showUserListBtn1"  class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
													<input type="hidden" class="inputbtnRefViewGray code" id="assetsUserCode" name="assetsUserCode1" >
                                                </td>
												<!-- 5 -->
												<td class="tdpadding"><input type="text" name="internalOrderNo" size='10' id="internalOrderNo1"></td>
												...
												<td class="tdpadding" hid="hid"><input type="text" name="payCount" size='10' id="payCount"></td>
												...
												<td class="tdpadding" hid="hid"><input type="text" name="taxUnit" id="taxUnit" size='10' value="0"></td><!-- 含税单价 -->
												<!-- 10 -->
												<td class="tdpadding" hid="hid"><input type="text" name="netPrice" class='rightalign' id="netPrice" size="10" value="0.00"></td><!-- 净价 -->
												<!-- 15 -->
												<td class="tdpadding"><input type="text" name="avaliableSumMoney" class='rightalign' id="avaliableSumMoney1" size="10" readonly="readonly"></td><!-- 可用预算金额 -->
												<td class="tdpadding" hid="hid"><input type="text" name="taxTotalPrice" class='rightalign' id="taxTotalPrice" size="10"></td><!-- 含税总价-->
												<td class="tdpadding" hid="hid"><input type="text" name="tax" class='rightalign' id="tax" size="10" readonly="readonly"></td><!-- 税额-->
												<td class="tdpadding"><input type="text" name="assetsIncreaseValue" class='rightalign' id="assetsIncreaseValue" size="10" value="0.00"></td><!-- 资产增加价值-->
												<td class="tdpadding"><input type="text" name="text" class='rightalign' id="text" size="10"></td><!-- 资产增加价值文本-->
												<td class="tdpadding"><input type="text" name="budgetYear" class='rightalign' id="budgetYear1" size="5" readonly="readonly"></td><!-- 预算年度-->
												<td class="tdpadding" hid="hid"><input type="text" name="payPrice" class='rightalign' id="payPrice" size="10"></td><!-- 本次申请金额(原币)-->
												<td class="tdpadding" hid="hid"><input type="text" name="advanceOffsetPrice" class='rightalign' id="advanceOffsetPrice" size="10" value="0.00"></td><!-- 本次预付冲减金额-->
												<td class="tdpadding" hid="hid"><input type="text" name="finalPrice" class='rightalign' id="finalPrice" size="10" value="0.00"></td><!-- 尾款金额-->
												<td class="tdpadding" hid="hid"><input readonly='readonly' name="finalPaymentDate" value="" type="text" id="finalPaymentDate" class="Wdate" onclick="WdatePicker({skin:'ext'});"></td><!-- 尾款付款时间-->
												<!-- 20 -->
												<td class="tdpadding" hid="hid"><input type="text" class='rightalign' name="payPriceLocal" id="payPriceLocal" size="10"></td>
											</tr>
										</tbody>
											...
											<tr style="white-space:nowrap;">
												...
												<td hid="hid"></td>
												<td></td>
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumtaxTotalPrice" size="10"></td><!-- 含税总价合计-->
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumtax" size="10"></td><!-- 税额合计-->
												...
												<td></td>
												<td></td>
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumpayPrice" size="10"></td><!-- 本次申请金额(原币)合计-->
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumadvanceOffsetPrice" size="10"></td><!-- 冲减预付金额合计-->
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumfinalPrice" size="10"></td><!-- 尾款金额合计-->
												<td hid="hid"></td>
												<td class='tdpadding' hid="hid"><input type="text" class='rightalign' readonly="readonly" name="" id="sumpayPriceLocal" size="10"></td><!-- 本次申请金额(本币)合计-->
											</tr>
                                ...
                                <div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
                                    <div>
                                        <table id="table_add_detail" style="width:100%" class="adminlist" cellspacing="0" rules="all" border="1" id="gridDataList" style="border-collapse:collapse;">
                                            ...
                                            <%-- <c:forEach items="${allPaymentPaymentMappingModels}" var="pd" varStatus="i">	
                                            <tr class="bodyTr" style="white-space:nowrap;">
												...
												<td class="tdpadding"><input class="rightalign" value='${pd.compCode}' type="text" readonly name="compCode" id="compCode" size="10"></td>
												<td class="tdpadding"><input class="rightalign" value='${pd.iyear}' readonly  type="text" name="iyear" id="iyear" size="10"></td>
												<td class="tdpadding"><input value='${pd.imonth}' class="rightalign" type="text" name="imonth" id="imonth" size="10" readonly></td>
												<td class="tdpadding"><input class="rightalign" value="${pd.caccountCode}" type="text" name="caccountCode" id="caccountCode" size="10" readonly></td>
												...
												<td class="tdpadding"><input class="rightalign" value="${pd.cspCode}" type="text" name="cspCode" id="cspCode" size="10" readonly></td>
												<td class="tdpadding"><input class="rightalign" value="${pd.iamount}" type="text" name="iamount" id="iamount" size="10" readonly></td>
												<td class="tdpadding"><input class="rightalign" value="${pd.cdepCode}" type="text" name="cdepCode" id="cdepCode" size="8" readonly></td>
												<td class="tdpadding"><input class="rightalign" value="" type="text" name="payPrice" id="payAmount" size="10" onkeyup="value=value.replace(/[^\d.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" ></td>
											</tr>
                                            </c:forEach> --%>
                                            </tbody>
...
<script type="text/javascript">
	...
	$(function(){ 
		...
		/* /* var trs = $("td[start='hid']"); 
		for(i = 0; i < trs.length; i++){ 
		trs[i].style.display = "none"; 
		}
		var ths = $("th[start='hid']"); 
		...
		if(paymentType=="验收款"){
			$("#tbody_detail_detail").find('input[name^=gvdata]').each(function(){
				if($(this).attr('checked')){
					var companyCode = $(this).parent().parent().find("#compCode").val();//预付冲销所选公司
					var compCode = $("#company").val().split("-")[0];
					if(compCode!=companyCode){
						mess += "所选冲减明细公司与所属公司不对应，请重新选择！";
							flag = false;
							return ;
					}
...
/*         tableHtml += "<td class='tdpadding' start='hid'><input type='text' name='mainAssetCode' size='10' id='mainAssetCode'></td>";
       	tableHtml += "<td class='tdpadding' start='hid'><input type='text' name='secondary' class='rightalign' id='secondary' size='7'></td>"; */
  ...
  //表单封装json
   ...
   //获取字符串的字节长度
	...
	/* $('#insertType').change(function(){
		var insertType = $("#insertType").children("option:selected").val();
		if (insertType == "价值新增") {
			var trs = $("td[hid='hid']"); 
			for(i = 0; i < trs.length; i++){ 
			...
			var ths = $("th[hid='hid']"); 
			for(i = 0; i < ths.length; i++){ 
			ths[i].style.display = "none"; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
			var trs1 = $("td[start='hid']");
			for(i = 0; i < trs1.length; i++){ 
			trs1[i].style.display = ""; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
			var ths1 = $("th[start='hid']"); 
			for(i = 0; i < ths1.length; i++){ 
			ths1[i].style.display = ""; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
			//$("#txtStandardComputer").removeAttr("disabled");
		}
		else{
			var trs = $("td[hid='hid']"); 
			for(i = 0; i < trs.length; i++){ 
			...
			var ths = $("th[hid='hid']"); 
			for(i = 0; i < ths.length; i++){ 
			ths[i].style.display = ""; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
			var trs1 = $("td[start='hid']");
			for(i = 0; i < trs1.length; i++){ 
			trs1[i].style.display = "none"; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
			var ths1 = $("th[start='hid']"); 
			for(i = 0; i < ths1.length; i++){ 
			ths1[i].style.display = "none"; //这里获取的trs[i]是DOM对象而不是jQuery对象，因此不能直接使用hide()方法 
			}
		}
	}); */
</script>
