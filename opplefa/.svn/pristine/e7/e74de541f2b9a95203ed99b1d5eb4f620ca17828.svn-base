...
(function($) {
	...
	function renderpager(pagenumber, pagecount, buttonClickCallback) {         
		...
		var strgoto = $("<li class='thpoint' style='margin-top:-7px;border:0px solid red;height:0px;'>当前&nbsp;<span style='border:0px solid blue;'><input type='text' value='"+pagenumber+"' maxlength='6' id='gotoval' style='width:20px; height:14px;margin-top:7px;padding-top:6px;'/></span>&nbsp;页</li>");
