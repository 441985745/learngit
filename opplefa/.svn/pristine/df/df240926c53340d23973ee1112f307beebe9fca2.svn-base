       ...
       <form id="basicInfo">
          <table style="width:100%;" class="ll">
            ...
            <tr rowspan="2">
              ...
              <td class="td_left"><input type="text" class="td_input" id="applyPeople" name="applyPeople" value="${param.applyPeople}"/></td>
              <td class="td_right"><span>*</span>盘点层级:</td>
              <td class="td_left">
                <select class="td_select select_color" id="inventoryLevels" name="inventoryLevels" onchange="changeLevels()">
                   ...
                   <option class="option_color" value="公司" >公司</option>
                </select>
               </td>
                 <td class="td_right">盘点负责人:</td>
              <td class="td_left">
                <input class="td_input"  type="text" id="inventoryPeople" name="inventoryPeople" value="${param.inventoryPeople}"/>
              </td>
            ...
            <tr>
              ...
              <td class="td_left">
                 <input  type="text" id="inventoryApplyDate" name="inventoryApplyDate" class="td_input Wdate" style="width: 160px;height: 25px;" onclick="WdatePicker({skin:'ext'});" value="${param.inventoryApplyDate}">
              </td>
              <td class="td_right">盘点时间区间:</td>
              <td class="td_left">
                 <input  type="text" id="inventoryDate" name="inventoryDate" class="td_input Wdate" style="width: 160px;height: 25px;" onclick="WdatePicker({skin:'ext'});" value="${param.inventoryDate}">
                 <%-- ~<input  type="text" id="inventoryDate" name="inventoryDate" class="td_input Wdate" style="width:76px;height: 25px;" onclick="WdatePicker({skin:'ext'});" value="${param.inventoryDate}"> --%>
              </td>
...
<%--            <tr>
     ...
     <script type="text/javascript">
       ...
       function saveSponsorCheck(sublist){
    	  ...
    	  $.ajax({
    		   type:"post",
    		   url:"${dynamicURL}/check/api/saveSponsorCheck?"+$('#basicInfo').serialize()+'&applicationDate='+d+'&applicationDate1='+d1+'&sublist='+sublist,
    		   async:false,
               success: function(data) {
                    if(data.errorMessages.length > 0){
                	   alert(data.errorMessages);ss
                	   return;
                    }
                       alert("操作成功！");
                       dg.cancel();
