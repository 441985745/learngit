                    ...
                    <table id="Table5" cellpadding="0px" cellspacing="0" class="tablenoborder" style="width:100%;">
                        ...
                        <tr>
                            <td class="titlefontsize" align="left">
                                ...
                                基本信息&nbsp&nbsp&nbsp<a
                                    href="${dynamicURL}/download/downLoadFile?downloadFileName=固定资产管理制度.pdf">固定资产管理制度.pdf</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
							...
							<span id="spanCompany">
								...
								<input readonly="readonly" class="searchinput" style="background-color: #CCCCCC;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="spanBudgetDepartment"><input
                                                    style="width: 100px; background-color: #CCCCCC;" readonly="readonly"
                                                    name="budgetDepartmentName" value="" type="text"
                                                    id="txtBudgetDepartment" class="inputbtnRefViewGray"></span><input
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdtext">
                                            <input class="searchinput" readonly name="applyDepartment" type="text"
                                                   value="${userDeptInfo.departmentName}" id="txtApplyDepartment">
                                            <input class="searchinput" readonly name="applyDepartmentCode" type="hidden"
                                                   value="${userDeptInfo.departmentCode}" id="txtApplyDepartmentCode">
                                        </td>
                                        ...
                                        <td id="tdWorkShopTypes">
                                            <input type="text" class="searchselect" style="background-color: #CCCCCC;"
                                                   name="workShopType" id="txtWorkShopType" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="searchselect" name="assetType" id="txtAssetType1">
                                                <c:forEach items="${attachConfigList}" var="attachConfig"
                                                           varStatus="status">
                                                    <option value="${attachConfig.assetType}" ${attachConfig.assetType == "IT资产" ? "selected" : ""}>${attachConfig.assetType}</option>
                                                </c:forEach>
                                        ...
                                        <td>
                                            <input type="radio" id="rdExpensing" name="expensing" value="Y">是
                                            <input type="radio" id="rdExpensing" name="expensing" value="N">否
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
...
//			dataType: "json",
    ...
    function saveOrder(strDraft) {
        ...
        $.ajax({
            ...
            async: false,
            contentType: "application/json; charset=utf-8",
            url: "${dynamicURL}/apply/api/saveApply",
...
//                dg.cancel();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    // 15
                    divHtml += "<td class='tdpadding'><input type='text' name='units' value='" + data[i].units + "' id='txtUnits' size='2' readonly></td>";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.result[0].length; i++) {
                    ...
                    divHtml += "<td class='tdpadding'><input type='text' name='assetsName' size='10' id='txtAssetsName' value='" + data.result[0][i].assetsName + "' readonly='readonly'></td>";
                    divHtml += "<td class='tdpadding'><input type='text' name='specificationParameter' size='10' id='txtSpecificationParameter' value='" + data.result[0][i].specificationParameter + "' readonly='readonly'></td>";
                    divHtml += "<td class='tdpadding'><input type='text' name='functions' size='10' id='txtFunctions' value='" + data.result[0][i].functions + "' readonly='readonly'></td>";
                    ...
                    // 5
                    divHtml += "<td class='tdpadding'><input type='text' name='optionalAccessories' size='10' id='txtOptionalAccessories' value='" + data.result[0][i].optionalAccessories + "'  readonly='readonly'></td>";
                    divHtml += "<td class='tdpadding'><input type='text' name='acceptanceCriteria' size='10' id='txtAcceptanceCriteria'  value='" + data.result[0][i].acceptanceCriteria + "'  readonly='readonly'></td>";
                ...
                for (var i = 0; i < data.result[1].length; i++) {
                    ...
                    divDetailHtml += "<td class='tdpadding'><input type='hidden' name='demandDetailId' value='" + data.result[1][i].id + "'><input type='text' name='assetsName' id='txtAssetsName' value='" + data.result[1][i].assetsName + "' readonly='readonly'></td>";
                    // 5
    ...
    $("#txtAssetType1").change(function () {
        ...
        /* var assetsType = $("#txtAssetType1").children("option:selected").val();
         ...
         $("#txtBudgetDepartment").val($("#deptName").val());
         $("#txtYsssbm").val($("#deptCode").val());
         $("#companyForIt").hide();
