					...
					<form id = "addForm">
						<table border="0" cellspacing="0" cellpadding="0" id="format">
							...
							<tr>
								...
								<td><input name="assetsCode" type="text" class="colorblur require-red" /> </td>
							</tr>
							<tr>
								<td class="tdtitle"><span>*</span>资产名称:</td>
								<td><input name="assetsName" type="text" class="colorblur require-red"/></td>
							</tr>
							<tr>
								<td class="tdtitle"><span>*</span>规格参数:</td>
								<td><input name="specificationParameter" type="text" class="colorblur require-red"/></td>
							</tr>
							<tr>
								<td class="tdtitle">数据状态:</td>
								<td>
									<select index="1" name="status" id="txtStatus" class="colorblur" style="width: 60px;">
...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#btnSave").click(function(){//保存
			add(dg, this, '${dynamicURL}/config/standCompConf/add');
		});
	});
