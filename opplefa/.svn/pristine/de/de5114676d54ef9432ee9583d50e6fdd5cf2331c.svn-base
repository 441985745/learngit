                    ...
                    <table id="Table8"  border="0" cellpadding="3px" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td>
								...
								<%-- <input class="searchinput" readonly name="officeLocation" type="hidden" value="${notPoPaymentOrder.officeLocation}" id="officeLocation"> --%>
							</td>
							<td style="text-align: right"><font color="red" >*</font>所属部门:</td>
							<td>
		                        <span id ="spanBudgetDepartment"><input style="width: 100px;" readonly="readonly" name="departmentName" value="${notPoPaymentOrder.departmentName}" type="text" id="txtBudgetDepartment" class="inputbtnRefViewGray" ></span><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanDep();"><input id="btntxtYsssbmShow" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
							...
							<td>
								<select class="searchselect" name="officeLocation" id="officeLocation">
									...
									<c:choose>
									  <c:when test="${scanLocation.clocationname==notPoPaymentOrder.officeLocation}">
							...
							<td class="tdtext">
								...
								<input readonly='readonly' class='searchinput' name='taxRateCode' type='hidden' value='${notPoPaymentOrder.taxRateCode}' id='taxRateCode'>
							</td> --%>
						</tr>
						<tr>
							...
							<td>
								...
								<input class="searchinput" hidden name="applyUserCode" type="text" value="${notPoPaymentOrder.applyUserCode}" >
							</td>
							<td style="text-align: right;">所属公司:</td>
							<td class="tdtext">
								<%-- <input  class='searchinput' name='companyName' type='text' value='${notPoPaymentOrder.companyName}' id=''> --%>
						...
						<tr>
	                        ...
	                        <td class="tdtext" >
								...
								<input readonly="readonly" class="searchinput" style="background-color: #CCCCCC;" name="costCenterCode" type="hidden" value="${notPoPaymentOrder.costCenterCode}" id="txtCostCenterCode">
								</span>
							</td>
							<td style="text-align: right" >汇率:</td>
							<td class="tdtext"><input class='searchinput' name='exchangeRate' type='text' value="${notPoPaymentOrder.exchangeRate}"   id='exchangeRate'></td>
						</tr>
						<tr> 
						...
						<tr> 
							<td style="text-align: right; width: 90px;"><span style="color: red">*</span>验收款单号:</td>
							<td>
								<select class="searchselect" name="acceptOrderNumber" id="acceptOrderNumber" onchange="selectCdocument()">
									...
									<c:forEach items="${acceptOrderNumbers}" var="acd">
										<c:choose>
										  <c:when test="${acd.cdocument==notPoPaymentOrder.acceptOrderNumber}">
										  <option value="${acd.cdocument}" selected="selected" >${acd.cdocument}</option>
										  </c:when>
										  <c:otherwise>
                    ...
                    <table id="Table8" border="0" cellpadding="3px" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td>
								...
								readonly="readonly" value="${notPoPaymentOrder.paymentPeople}" id="paymentPeople"><input id='gvdMeeting_btnClearsk_0'  class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="ClearObj();"><input id="showUserListBtn"  class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
						...
						<tr>
							...
							<td>
								<input style="width: 100px;" name="supplierCode" value="${notPoPaymentOrder.supplierCode}" type="text" id="supplierCode" class="inputbtnRefViewGray" readonly="readonly"></span><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' onclick="cleanSupp();"><input id="butSupplierShow" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
								<%-- <input  class='searchinput' name='supplierCode' type='text' value='${notPoPaymentOrder.supplierCode}' id='supplierCode'> --%>
							</td>
							<td style="text-align: right;">联系人:</td>
							<td class="tdtext">
								<input  class='searchinput' name='contacts' type='text' value='${notPoPaymentOrder.contacts}' id='contacts' readonly="readonly">					
	                        </td>
						...
						<tr> 
							...
							<td>
								<input  class='searchinput' name='supplierName' type='text' value='${notPoPaymentOrder.supplierName}' id='supplierName' readonly="readonly">
							</td>
							<td style="text-align: right"><font color="red" >*</font>收款账号:</td>
	                        <td class="tdtext" >
								<span id="spanCostCenter">
								<input  class="searchinput" style="background-color: #CCCCCC;" name="bankNumber" type="text" value="${notPoPaymentOrder.bankNumber}" id="bankNumber" readonly="readonly">
								</span>
							</td>
						...
						<tr> 
							...
							<td>
								<input  class='searchinput' name='country' type='text' value='${notPoPaymentOrder.country}' id='country' readonly="readonly">
							</td>
							<td style="text-align: right; width: 90px;">开户行名称:</td>
							<td>
								<input  class='searchinput' name='bankName' type='text' value='${notPoPaymentOrder.bankName}' id='bankName' readonly="readonly">
							</td>
						...
						<tr>
							...
							<td>
								<input  class='searchinput' name='bankCode' type='text' value='${notPoPaymentOrder.bankCode}' id='bankCode' readonly="readonly">
							</td>
						</tr>
						</tbody>
					</table>
...
<script type="text/javascript">
	...
	function saveOrder(objHeader,draft){
	    objHeader.draft = draft;
