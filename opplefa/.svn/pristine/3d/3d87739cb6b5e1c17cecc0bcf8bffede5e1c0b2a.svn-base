...
@Data
public class DocumentHeaderModel { // 是否必输

	private String objType; // 参考过程
	private String objKey; // 对象关键字
	private String objSys; // 源凭证的逻辑系统
	private String busAct; // 业务事务 是
	private String username; // 用户名 是
	private String headerTxt; // 凭证抬头文本
	private String compCode1; // 公司代码 是
	private String docDate; // 凭证中的凭证日期 是
	private String pstngDate; // 凭证中的记帐日期 是
	private String transDate; // 换算日期
	private Integer fiscYear; // 会计年度
	private Integer fisPeriod; // 会计期间
	private String docType; // 凭证类型 是
	private String refDocNo; // 参考凭证编号 是
	private String acDocNo; // 会计凭证号码
