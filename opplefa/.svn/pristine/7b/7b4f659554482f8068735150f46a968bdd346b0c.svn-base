                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="1" class="formtable">
                        ...
                        <tr id="trPortrait">
                            ...
                            <td class="tdtext">
                                <input id="chkPortrait" type="checkbox" name="chkPortrait">
                            </td>
                        </tr>
                        </tbody>
                    </table>
    ...
    function setParent(dialogId, isMail, isPhoneMessage, idea,isPortrait) {
        if (dialogId != '') {
            if (dg.iDG(dialogId)) {
                ...
                dg.iWin(dialogId).commitDeny(isMail, isPhoneMessage, idea,isPortrait, $('#denyActivitiId').val());
                dg.cancel();
            }
            else {
                alert('请先打开父窗口');
