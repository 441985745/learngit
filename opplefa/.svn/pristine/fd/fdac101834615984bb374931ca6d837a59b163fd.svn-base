...
<body>
    ...
    <div id="purchaseTab" class="easyui-tabs" style="width:850px;">
       <div title="订单信息" id="tabsa" style="width:90%;margin: 0 auto;min-width:800px">
       <div>
       <form id="paymentOrderFormHeader">
        <table id="Table5" cellpadding="0px" cellspacing="0" style="width:90%;margin: 0 auto;">
            <tbody><tr>
            ...
            <tr>
                <td>
                    <table id="Table8" border="0" cellpadding="3px" cellspacing="0" style="width:100%;margin: 0 auto;">
						<tbody>
						<tr>
						...
						<tr>
							...
							<td>
								<input readonly='readonly' class='searchinput' name='supplierCode' type='text' value='${purchaseOrder.supplierCode}' id='supplierCode'>
							</td>
						...
						<tr> 
							...
							<td class="tdtext"><input class='searchinput' name='exchangeRate' type='text' value='${purchaseOrder.exchangeRate}' id='exchangeRate'></td>
						</tr>
						<tr> 
							<td style="text-align: right;">公司名称:</td>
							<td class="tdtext">
								<input readonly='readonly' class='searchinput' name='companyName' type='text' value='${purchaseOrder.companyName}' id='companyName'>	
	                        </td>
							<td style="text-align: right; width: 90px;">公司具体名称:</td>
							<td>
								<input readonly='readonly' class='searchinput' name='companySpecificName' type='text' value='${purchaseOrder.companySpecificName}' id='companySpecificName'>
							</td>
							<td style="text-align: right" >银行账号:</td>
							<td class="tdtext"><input readonly='readonly' class='searchinput' name='bankNumber' type='text' value='${purchaseOrder.bankNumber}' id='bankNumber'></td>
						</tr>
						<tr> 
							<td style="text-align: right;">付款类型:</td>
							<td class="tdtext">
								<input readonly='readonly' class='searchinput' name='paymentType' type='text' value='${paymentTerms[0].paymentType}' id='paymentType'>	
								<input readonly='readonly' class='searchinput' name='nper' type='hidden' value='${paymentTerms[0].nper}' id='nper'>
								<input readonly='readonly' class='searchinput' name='isLastTerm' type='hidden' value='${paymentOrder.isLastTerm}' id='isLastTerm'>			
	                        </td>
	                        <td style="text-align: right;">采购订单号:</td>
							<td class="tdtext">
								<input readonly='readonly' class='searchinput' name='purchaseOrderId' type='text' value='${purchaseOrder.cdocument}' id='purchaseOrderId'>					
	                        </td>
							...
							<td class="tdtext">
								...
								<input readonly='readonly' class='searchinput' name='bankCode' type='hidden' value='${purchaseOrder.bankCode}' id='bankCode'>
							</td>
						</tr>
						<c:choose>
						    <c:when test="${paymentTerms[0].paymentType=='验收款'}">
							    <tr> 
								<td style="text-align: right;">付款比例(%):</td>
								<td class="tdtext">
									<input readonly='readonly' class='searchinput' name='paymentRatio' type='text' value='${paymentTerms[0].paymentRatio}' id='paymentRatio'>	
								...
								<td class="tdtext"><input readonly='readonly' class='searchinput' name='contactNumber' type='text' value='${purchaseOrder.contactNumber}' id='contactNumber'></td>
								</tr>
								<tr>
								...
								<td class="tdtext"><input readonly='readonly' class='searchinput' name='invoiceNumber' type='text' value='${purchaseOrder.contactNumber}' id='invoiceNumber' onkeyup="value=value.replace(/[^\d]/g,'')"></td>
        ...
        <table id="Table8" cellpadding="0px" cellspacing="0" class="tablenoborder" style="width:100%;margin: 0 auto;">
            <tbody>
            <tr>
                <td class="titlefontsize" align="left">
            ...
            <tr>
                <td colspan="4">
                    <table id="Table10"  border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;width:100%;margin: 0 auto;">
                        <tbody>
                        <tr>
                                    ...
                                    <div>
                                        <table id="table_detail" style="width:825px;" class="adminlist" cellspacing="0" rules="all" border="1" id="gridDataList" style="border-collapse:collapse;">
                                            ...
                                            <tr style="white-space:nowrap;">
                                                ...
                                                <c:if test="${paymentTerms[0].paymentType=='验收款'}">
                                               		 <th scope="col" class="tdpadding">已付验收款金额</th>
                                                </c:if>
                                                <c:if test="${paymentTerms[0].paymentType=='尾款'}">
                                               		<th scope="col" class="tdpadding"> 已付尾款金额</th>
                                                </c:if>                        
                                            ...
                                            <tr class="bodyTr" style="white-space:nowrap;">
												...
												<td class="tdpadding">
												<input value='${pd.assetsName}' type="text" readonly name="assetsName" id="assetsName">
												<input value='${pd.costCenterCode}' type="hidden" readonly name="costCenterCode" id="costCenterCode">
												<input value='${pd.costCenter}' type="hidden" readonly name="costCenter" id="costCenter">
												</td>
												...
												<td class="tdpadding"><input class="rightalign" value="" type="text" name="payCount" id="payCount" size="5" onkeyup="value=value.replace(/[^\d]/g,'')" ></td><!-- 本次付款数量 -->
												<c:choose>
												  <c:when test="${paymentTerms[0].paymentType=='预付款'}">
												  <td class="tdpadding"><input class="rightalign" value="" type="text" name="payPrice" id="payPrice" size="5" onkeyup="value=value.replace(/[^\d.]/g,'')" readonly ></td><!-- 本次付款金额 -->
												  </c:when>
												  <c:otherwise>
												  <td class="tdpadding"><input class="rightalign" value="" type="text" name="payPrice" id="payPrice" size="5" onkeyup="value=value.replace(/[^\d.]/g,'')" ></td><!-- 本次付款金额 -->
												  </c:otherwise>
												</c:choose>
												...
												<c:if test="${paymentOrder.isLastTerm!='Y'||paymentTerms[0].paymentType=='预付款'}">
												  <td class="tdpadding"><input name="nextPayment" value="" type="text" id="nextPayment" class="Wdate" onclick="WdatePicker({skin:'ext'});"></td><!-- 下次付款时间 -->
												</c:if>
...
<%--													<input value='${pd.id}' type="hidden" name="paymentDetailId" id="paymentDetailId"><!-- 上次付款ID 被冲销的ID -->
												...
												<td class="tdpadding"><input class="rightalign" value="" type="text" name="payPrice" id="payAmount" size="5" onkeyup="value=value.replace(/[^\d.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" ></td>
											</tr>
                                            </c:forEach>
                                            </tbody>
