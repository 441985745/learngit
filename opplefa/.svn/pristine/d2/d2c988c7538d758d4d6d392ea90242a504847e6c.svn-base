                    ...
                    <form id = "updateForm">
                        <table border="0" cellspacing="0" cellpadding="0" id="format">
                            ...
                            <tr>
                                ...
                                <td><input name="unitCode" type="text" value="${assetUnit.unitCode}" class="colorblur require-red" disabled/> </td>
                            </tr>
                            <tr>
                                <td class="tdtitle"><span>*</span>单位名称:</td>
                                <td><input name="unitName" type="text" value="${assetUnit.unitName}" class="colorblur require-red" disabled/></td>
                            </tr>
                            <tr>
                                <td class="tdtitle">数据状态:</td>
                                <td>
                                    <select index="1" class="colorblur" name="status" id="txtStatus" style="width: 60px;" disabled>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea cols="50" rows="3" name="memo" id="memo" class="colorblur code" disabled>${assetUnit.memo}</textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
