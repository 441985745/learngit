                        ...
                        <table border="0" cellspacing="0" cellpadding="0" id="format">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="companyName" class="colorblur name require-red" id="companyName" readonly style="width: 160px;"/><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showCompanyListBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="deptName" type="text" id="deptName" class="colorblur name require-red" style="width: 160px;"/><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showDeptBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="costCenterName" id="costCenterName" class="colorblur name require-red" readonly style="width: 160px;"/><input class='btnRefView' title='点击清空参照文本框内容' type='button' value='X' style="width: 18px;" onclick="clearObj(this);"><input class='btnRefView showCostCenterBtn' title='点击打开参照文本框内容' type='button' value='…' style="width: 20px;">
                                </td>
                            </tr>
                            <tr>
                                <td class="tdtitle">数据状态 :</td>
                                <td>
                                    <select index="1" class="colorblur" name="status" id="txtStatus" style="width: 60px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea cols="50" rows="3" name="memo" class="colorblur" id="memo"></textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    function showCompanyDialog(){
        var url = "${dynamicURL}/company/searchCompanies?parentWindowId=adddeptCostCenter";
    ...
    function showDeptDialog(){
        var url = "${dynamicURL}/dept/getCodeAndName?parentWindowId=adddeptCostCenter";
        var parentWindow=dg.curWin;
        new parentWindow.$.dialog({ id: 'list', title: "所有部门", cover: true, page: url, width: 700, height: 400, btnBar: false, resize: false, maxBtn: false }).ShowDialog();
    }
    ...
    function showCostCenterDialog(companyCode){
        var url = "${dynamicURL}/costCenter/getCodeAndName?parentWindowId=adddeptCostCenter&companyCode=" + companyCode;
        var parentWindow=dg.curWin;
    ...
    $(function () {
        ...
        $("#btnSave").click(function(){//保存
            add(dg, this, '${dynamicURL}/config/deptCostCenter/addDeptCostCenter');
