...
public abstract class AbstractExcelExportTemplate<T> implements ExcelExportTemplate<T> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.haier.openplatform.excel.ExcelExportService#doExport(java.io.
	 * OutputStream)
	 */
	@Override
	public void doExport(HttpServletResponse response, String fileName, List<T> ts) throws IOException {
	 ...
	 * @param sheetIndex
	 */
	protected abstract void buildBody(int sheetIndex, List<T> ts);
