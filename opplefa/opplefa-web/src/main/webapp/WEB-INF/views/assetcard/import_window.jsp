...
<div id="easywin" style="display: none;">
	...
	<input type="file" accept=".xlsx" id="inputfile" name="inputfile"
		style="margin: 5px 0px;" /> <br /> <span>&nbsp&nbsp模板类型：</span> <select
		style="width: 130px;" name="uploadAssetType" id="uploadAssetType">
		<option value="IT资产">IT资产</option>
		<option value="行政资产">行政资产</option>
		<option value="计量器具">计量器具</option>
		<option value="机器设备">机器设备</option>
	</select> <input type="button" id="downloadBtn" value="下载模版" class="btn"
		style="margin: 5px 5px;" /> <input type="button" id="confirmImport"
		value="确定导入" class="btn" />
</div>
...
//            console.log(title);
            ...
            $downloadBtn.click(function() {
           		 fileName=$.trim($("#uploadAssetType").val())+".xlsx";   	
