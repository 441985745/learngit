...
<!--             <tr style="text-align: center;">
			...
			<tr> 
				...
				<td >
					${paymentOrder.companyCode}					
                </td>
				<td style="text-align: right;">供应商名称:</td>
				<td>
					${paymentOrder.supplierName}
				</td>
				<td style="text-align: right;">汇率:</td>
				<td >${paymentOrder.exchangeRate}</td>
			</tr>
			<tr> 
				<td style="text-align: right;">公司名称:</td>
				<td >
					${paymentOrder.companyName}	
                </td>
				<td style="text-align: right;">公司具体名称:</td>
				<td>
					${paymentOrder.companySpecificName}
				</td>
				<td style="text-align: right;">银行账号:</td>
				<td class="tdtext">${paymentOrder.bankNumber}</td>
			</tr>
			<c:choose>
     ...
     <!--    </br> -->
        ...
        <c:if test="${paymentOrder.paymentType=='验收款'&&paymentOrder.paymentRatio==100&&paymentOrder.capprovalstate=='已完成'}">
          <table class="table_list" style="border-top-width: 0;border-bottom-width: 0;">
				       ...
				       <td style="text-align:right;border-top-width: 0;border-bottom-width: 0;">发票凭证:</td>
