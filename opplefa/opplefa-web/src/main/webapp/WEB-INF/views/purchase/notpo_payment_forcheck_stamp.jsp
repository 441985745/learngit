    ...
    <div>
        <table class="table_list" style="border-bottom-width: 0;">
            ...
            <tr>
                ...
                <td>
                    ${notPoPaymentOrder.exchangeRate}
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ${notPoPaymentOrder.companySpecificName}
                </td>
                <td style="text-align: right;">银行账号:</td>
                <td>${notPoPaymentOrder.bankNumber}</td>
            </tr>
            <tr>
                <td style="text-align: right;">所属公司:</td>
                <td>
                    (${notPoPaymentOrder.companyCode})${notPoPaymentOrder.companyName}
                </td>
                ...
                <td class="tdtext">${notPoPaymentOrder.bankName}</td>
            </tr>
            <tr>
                <td style="text-align: right;">是否一次性费用化:</td>
                <td>
                    ${notPoPaymentOrder.isExpenseAssets=="Y"?"是":"否"}
                </td>
                ...
                <td class="tdtext">${notPoPaymentOrder.contactNumber}</td>
            </tr>
            <tr>
                <td style="text-align: right;">扫描地:</td>
                <td>
                    ${notPoPaymentOrder.scanLocation}
                </td>
                <td style="text-align: right;">税码/税率:</td>
                <td>
                    <fmt:formatNumber type="number" value="${notPoPaymentOrder.taxRate*100}" maxFractionDigits="0"/>%
                </td>
                <td style="text-align: right;">申请事由:</td>
                <td class="tdtext">${notPoPaymentOrder.applyFor}</td>
            </tr>
            <tr>
                <td style="text-align: right;">是否有增值税:</td>
                <td>
                    ${notPoPaymentOrder.isVat=="Y"?"是":"否"}
                </td>
                <td style="text-align: right;">发票号:</td>
                <td>
                    ${notPoPaymentOrder.invoiceNumber}
                </td>
                <td style="text-align: right;">付款类型:</td>
                <td class="tdtext">${notPoPaymentOrder.insertType}</td>
            </tr>
            <tr>
                <td style="text-align: right;">备注:</td>
                <td>
                    ${notPoPaymentOrder.remark}
                </td>
            </tr>
            <%--			<c:choose>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">是否有专票:</td>
                            <td>
                                ${paymentOrder.invoice=="Y"?"是":"否"}
                            </td>
                            <td style="text-align: right;">开户行:</td>
                            <td >
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">联行号:</td>
                            <td >${paymentOrder.contactNumber}</td>
                        </tr>
                        <tr >
                            ...
                            <td >
                                ${purchaseOrder.purchaseOrderSapId}
                            </td>
                            <td style="text-align: right;">是否最后一次付款:</td>
                            <td >
                                ${paymentOrder.isLastTime=="Y"?"是":"否"}
                            </td>
                        </tr>
                        <tr style="border-bottom-width: 0;">
                            <td style="text-align: right;border-bottom-width: 0;">申请事由:</td>
                            <td style="border-bottom-width: 0;" colspan="5">
                                ${paymentOrder.applyFor}
                            </td>
                        </tr>
                        </c:when>
                        <c:otherwise>
                        ...
                        <tr style="border-bottom-width: 0;">
                            <td style="text-align: right;border-bottom-width: 0;">采购订单号:</td>
                            <td style="border-bottom-width: 0;">
                                ${paymentOrder.purchaseOrderId}
                            </td >
                            <td style="text-align: right;border-bottom-width: 0;">sap采购订单号:</td>
                            <td style="border-bottom-width: 0;"colspan="3">
                                ${purchaseOrder.purchaseOrderSapId}
                            </td>
                        </tr>
                        </c:otherwise>
