                        ...
                        <tr>
                            <td>
                                <table id="Table8" border="0" cellpadding="3px" cellspacing="0" width="100%">
                                    <tbody>
                                    <tr>
                                        <input name='attachDepartManagerName' type='hidden' value=''
                                               id='attachDepartManagerName'>
                                        <input name='attachDepartManagerCode' type='hidden' value=''
                                               id='attachDepartManagerCode'>
                                        <input name='attachDepartAdminName' type='hidden' value=''
                                               id='attachDepartAdminName'>
                                        <input name='attachDepartAdminCode' type='hidden' value=''
                                               id='attachDepartAdminCode'>
                                        <input name='purchasingManagerCode' type='hidden' value=''
                                               id='purchasingManagerCode'>
                                        <input name='purchasingManagerName' type='hidden' value=''
                                               id='purchasingManagerName'>
                                        ...
                                        <td>
                                            <input class="searchinput" readonly name="purchaseOrderSapId"
                                                   style="background-color: #CCCCCC;" type="text" value=""
                                                   id="purchaseOrderSapId">
                                        </td>
                                ...
                                <input name='companyCode' type='hidden' value='' id='txtCompanyCode'> -->
                                        ...
                                        <td class="tdtext">
                                            <input class="searchinput" readonly name="purchasingGroup" type="text"
                                                   value="固定资产采购(113)" id="purchasingGroup">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="tdtext">
                                            <input class="searchinput" readonly name="procurementOrganization"
                                                   type="text" value="欧普照明非生产性采购(1001)" id="procurementOrganization">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <span id="spanBudgetDepartment"><input style="width: 100px;"
                                                                                   readonly="readonly"
                                                                                   name="budgetDepartmentName" value=""
                                                ...
                                                value='X' onclick="cleanDep();"><input id="btntxtYsssbmShow"
                                                                                       ...
                                                                                       value='…'>
                                            <input name="budgetDepartmentCode" value="" type="hidden" id="txtYsssbm"
                                                   class="inputbtnRefViewGray">
                                        </td>

                                        <td style="text-align: right"><font color="red">*</font>工厂代码:</td>
                                        <td>
                                            <!-- <input readonly="readonly" class="searchinput" style="background-color: #CCCCCC;" name="factoryCode" type="text" value="" id="factoryCode"> -->
                                            <select id="factoryCode" class="searchselect" name='factoryCode'></select>
                                        </td>
                                        <td style="text-align: right"><font color="red">*</font>订单类别:</td>
                                        <td class="tdtext">
                                            <select class="searchselect" name="orderType" id="orderType">
                                                <option value="">请选择</option>
                                                <option value="ZAB">固定资产(ZAB)</option>
                                                <option value="ZFB">费用(ZFB)</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <td>
                                <table id="Table8" border="0" cellpadding="3px" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input style="width: 100px;" name="supplierCode" value="" type="text"
                                                   id="supplierCode" class="inputbtnRefViewGray"></span><input
                                                id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button'
                                                value='X' onclick="cleanSupp();"><input id="butSupplierShow"
                                                                                        class='btnRefView'
                                                                                        title='点击打开参照文本框内容'
                                                                                        type='button' value='…'>
                                        </td>
                                        ...
                                        <td>
                                            <input suplc="Y" class="searchinput" name="supplierName" type="text"
                                                   value="" id="supplierName">
                                        </td>
                                        <td style="text-align: right; width: 90px;">邮编:</td>
                                        <td class="tdtext">
                                            <input suplc="Y" class="searchinput" name="zipCode" type="text" value=""
                                                   id="zipCode">
                                            <input suplc="Y" class="searchinput" name="paymentTypeName" type="hidden"
                                                   value="" id="paymentTypeName">
                                            <input class="searchinput" name="paymentTypeCode" type="hidden" value=""
                                                   id="paymentTypeCode">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input suplc="Y" class="searchinput" name="bankName" type="text" value=""
                                                   id="bankName">
                                            <input class="searchinput" name="bankCode" type="hidden" value=""
                                                   id="bankCode">
                                        </td>
                                        <td style="text-align: right">银行账号:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="bankNumber" type="text" value=""
                                                   id="bankNumber">
                                        </td>
                                        <td style="text-align: right">联行号:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="contactNumber" type="text"
                                                   value="" id="contactNumber">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">联系人:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="contacts" type="text" value=""
                                                   id="contacts">
                                        </td>
                                        <td style="text-align: right">电话:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="telephone" type="text" value=""
                                                   id="telephone">
                                        </td>
                                        <td style="text-align: right">公司地址:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="companyAddress" type="text"
                                                   value="" id="companyAddress">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">公司具体名称:</td>
                                        <td>
                                            <input suplc="Y" class="searchinput" name="companySpecificName" type="text"
                                                   value="" id="companySpecificName">
                                        </td>
                                        <td style="text-align: right"><font color="red">*</font>币种:</td>
                                        <td>
                                            <!-- suplc="Y" --> <select class="searchselect" name="currencyCode"
                                                                       id="currencyCode" onchange="selectCurrency()">
                                        ...
                                        <td class="tdtext">
                                            <input class="searchinput" name="exchangeRate" type="text" value=""
                                                   id="txtExchangeRate" readonly="readonly">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">国家:</td>
                                        <td>
                                            <input class="searchinput" readonly="readonly" name="country" type="text"
                                                   value="" id="country">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input size="110" name="deliveryAddress" type="text" value=""
                                                   id="deliveryAddress">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input size="110" name="headerTextDescription" type="text" value=""
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input size="110" name="buyerRemark" type="text" value="" id="buyerRemark">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <tr>
                                    <td class="tdtitle" style="text-align: right" colspan="2">
                                        <div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
                                            <div>
                                                <table id="table_detail" width="825px" class="adminlist" cellspacing="0"
                                                    ...
                                                    <tr style="white-space:nowrap;">
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td><input class="rightalign" type="text" name=""
                                                                   id="sumApplyCount" size="5" readonly="readonly"></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td><input class="rightalign" type="text" name=""
                                                                   id="sumPurchasePrice" size="5" readonly="readonly">
                                                        </td>
                                                        <td><input class="rightalign" type="text" name=""
                                                                   id="sumPurchasePriceLocal" size="5"
                                                                   readonly="readonly"></td>
                                                        <td>
                                                            <!-- <input class="rightalign" type="text" name="" id="sumNetPrice" size="5" readonly="readonly"> --></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                    ...
                                    <div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
                                        <div>
                                            <table id="table_detail_detail" class="adminlist" cellspacing="0"
                                                ...
                                                <tbody id="tbody_detail_detail"></tbody>
                                    ...
                                    <div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
                                        <div>
                                            <table id="table_pay" class="adminlist" cellspacing="0" rules="all"
                                                ...
                                                <tr style="white-space:nowrap;">
                                                    <th scope="col">
                                                        <input id="gvdataList_CheckAll_Pay" type="checkbox"
                                                               name="gvdataList$ctl01$CheckAll"
                                                ...
                                                <!-- <tr class="bodyTr" style="white-space:nowrap;">
                                                    ...
                                                    <td class="tdpadding"><input size="5" type="text" name="nper" id='nper' class='rightalign' value="1" readonly></td>
                                                    <td class="tdpadding">
                                                ...
                                                <tr class="bodyTr" style="white-space:nowrap;">
                                                    ...
                                                    <td class="tdpadding"><input size="5" type="text" name="nper" id='nper' class='rightalign' value="2" readonly></td>
                                                    <td class="tdpadding">
                                                        <select style="width: 150px;" name="paymentType">
                                                            <option value="预付款">预付款</option>
                                                            <option value="验收款" selected="selected">验收款</option>
                                                            <option value="尾款">尾款</option>
                                                        </select>
                                                    </td>
                                                    <td class="tdpadding"><input type="text" name="paymentRatio" id="paymentRatio" value="30.00" size="10" class="rightalign"></td>
                                                    <td class="tdpadding"><input type="text" name="paymentRemarks" id="paymentRemarks" value="第一次验收后7天" size="30"></td>
                                                </tr>
                                                <tr class="bodyTr" style="white-space:nowrap;">
                                                    <td>
                                                        <input id="gvDataList_chkBolDel_0" type="checkbox" name="gvDataList_chkBolDel_0">
                                                    </td>
                                                    <td class="tdpadding"><input size="5" type="text" name="nper" id='nper' class='rightalign' value="3" readonly></td>
                                                    <td class="tdpadding">
                                                        <select style="width: 150px;" name="paymentType">
                                                            <option value="预付款">预付款</option>
                                                            <option value="验收款">验收款</option>
                                                            <option value="尾款" selected="selected">尾款</option>
                                                        </select>
                                                    </td>
                                                    <td class="tdpadding"><input type="text" name="paymentRatio" id="paymentRatio" value="40.00" size="10" class="rightalign"></td>
                                                    <td class="tdpadding"><input type="text" name="paymentRemarks" id="paymentRemarks" value="第二次验收后10天" size="30"></td>
                                                </tr> -->
                                                </tbody>
                                                <tr class="bodyTr" style="white-space:nowrap;">
                                                    <td></td>
                                                    ...
                                                    <td class="tdpadding"><input id="sumPaymentRatio" type="text"
                                                                                 name="" value="0.00" size="10"
                                                                                 class="rightalign" readonly="readonly">
                                                    </td>
                                                    <td class="tdpadding"></td>
                                                </tr>
                                            </table>
                                        ...
                                        <div id="div1" class="divGrid" style="overflow-x: scroll; overflow-y: visible;">
                                            <div>
                                                ...
                                                <table id="table_add_detail" class="adminlist" cellspacing="0"
                                                    ...
                                                    <tr style="white-space:nowrap;">
                                                        <th scope="col">
                                                            <input id="gvDataList_CheckAll_Add" type="checkbox"
                                                                   name="gvDataList$ctl01$CheckAll"
...
<div id="addApplyDetailWindow" name="" class="easyui-window" title="明细" data-options="iconCls:'icon-save'"
     style="width:825px;height:280px;padding:5px;" closed="true">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'" style="padding:10px;">
            <div id="Div2" style="margin-left: 0px; margin-top: 0px;">
...
<div id="supplierWindow" name="" class="easyui-window" title="选择供应商" data-options="iconCls:'icon-save'"
     style="width:750px;height:400px;padding:5px;" closed="true">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'" style="padding:10px;">
            ...
            <div style="width: 700px;height: 270px;overflow-x: scroll; overflow-y: visible;">
                <table id="supplierBudget" class="adminlist" rules="all" style="border-collapse:collapse;"
                       cellspacing="0" border="1" cellpadding="6px">
                    <thead>
                    <tr>
...
//			dataType: "json",
    ...
    function setValues() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#purchasingManagerName").val(data.purchasingManagerName);//采购经理
    ...
    function saveOrder(strDraft) {
        ...
        var taxRateCode = taxRate.substr(0, 2);//alert(taxRateCode);
        ...
        ///获得付款条件信息 封装Json对象
        var objPrr = constructObjectFromTable(objpay, $("#payment_tbody .bodyTr"));
        ...
        $.ajax({
            ...
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            url: "${dynamicURL}/purchase/api/savePurchase",
...
//                dg.cancel();
    ...
    $("#txtThisApplyCount").live("click", function () {
        var top = "150px";
        var left = "30px";
        $('#addApplyDetailWindow').window('open').window('resize', {
            width: '825px',
            height: '280px',
            top: top,
            left: left
    ...
    $("#btnDetailSure").click(function () {
        ...
        for (var i = 0; i < objArr.length; i++) {
            ...
            if ((objArr[i].mappingApplyCount - objArr[i].mappingNotApplyCount) > 0) {
                alert("采购数量不能超过未采购数量！");
                flag = true;
                break;
            }
    ...
    $("#btnDetailSave").click(function () {//确定新增明细
        ...
        var purchaseOrderDetailModels = constructObjectFromTable(obj, $("#tbody_add_detail .bodyTr"));
