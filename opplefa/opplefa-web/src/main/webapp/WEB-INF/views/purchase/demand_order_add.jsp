       ...
       <div width="100%">
		...
		<table id="Table5" cellpadding="0px" cellspacing="0" class="tablenoborder" style="width:100%;">
			<tbody><tr>
				...
				基本信息&nbsp&nbsp&nbsp<a href="${dynamicURL}/download/downLoadFile?downloadFileName=固定资产管理制度.pdf">固定资产管理制度.pdf</a></td>
			</tr>
			<tr>
				<td>
					<table id="Table8" border="0" cellpadding="3px" cellspacing="0" width="100%">
						<tbody>
						<tr>
							<input name='attachDepartManagerName' type='hidden' value='' id='attachDepartManagerName'>
							<input name='attachDepartManagerCode' type='hidden' value='' id='attachDepartManagerCode'>
							<input name='attachDepartAdminName' type='hidden' value='' id='attachDepartAdminName'>
							<input name='attachDepartAdminCode' type='hidden' value='' id='attachDepartAdminCode'>

							<input name='attachDepartMajordomoCode' type='hidden' value='' id='attachDepartMajordomoCode'>
							<input name='attachDepartMajordomoName' type='hidden' value='' id='attachDepartMajordomoName'>
							<input name='attachDepartVpresidentCode' type='hidden' value='' id='attachDepartVpresidentCode'>
							<input name='attachDepartVpresidentName' type='hidden' value='' id='attachDepartVpresidentName'>
							<input name='purchasingManagerCode' type='hidden' value='' id='purchasingManagerCode'>
							<input name='purchasingManagerName' type='hidden' value='' id='purchasingManagerName'>
							<td style="text-align: right">单据号:</td>
							<td>
								<input class="searchinput" cc='cc' readonly name="cdocument" type="text" value="${demandOrder.cdocument}" id="txtDemandOrderId">
							</td>
							<td style="text-align: right"><font color="red" >*</font>所属公司:</td>
							<td>
							<span id="spanCompany">
								<select id="txtCompanyCode" class="searchselect" name='companyCode'></select>
								<!-- <input readonly='readonly' class='searchinput' style="background-color: #CCCCCC;" name='companyName' type='text' value='' id='txtCompany' onclick='ysssbmCom()'>
						...
						<tr>
							...
							<td>
								<input class="searchinput" readonly="readonly"  value='${demandOrder.applyUser}'  name="applyUser" type="text" value="" id="applyUser">
								<input class="searchinput" readonly="readonly"  value='${demandOrder.applyUserCode}'  name="applyUserCode" type="hidden" value="" id="applyUserCode">
							</td>
							...
							<td>
								<input type="radio" id="txtAssemble" name="assemble" value="Y">是
								<input type="radio" id="txtAssemble" name="assemble" value="N">否
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">申请日期:</td>
							<td class="tdtext">
								<input class="searchinput" readonly="readonly" name="applyDate" type="text" value="<fmt:formatDate value='${demandOrder.applyDate}'  pattern='yyyy-MM-dd'/>" id="txtApplyDate">
							</td>
							...
							<td>
								<input type="radio" id="txtBuilding" name="building" value="Y">是
								<input type="radio" id="txtBuilding" name="building" value="N">否
							</td>
						</tr>
						<tr>
							...
							<td class="tdtext">
								...
								<input class="searchinput" readonly name="applyDepartmentCode" type="hidden" value="${userDeptInfo.departmentCode}" id="txtApplyDepartmentCode">
							</td>
							<td style="text-align: right" >区域:</td>
							<td class="tdtext">
								<select class="searchselect" style="background-color: #CCCCCC;" name="region" id="txtRegion" onclick="selectPlat()">
                                </select>
							</td>
							<td style="text-align: right;">车间类型:</td>
							<td class="tdtext">
								<input type="text" class="searchselect" style="background-color: #CCCCCC;" name="workShopType" id="txtWorkShopType" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td style="text-align: right"><font color="red" >*</font>预算所属部门:</td>
	                        <td>
		                        <span id ="spanBudgetDepartment"><input style="width: 100px;" readonly="readonly" name="budgetDepartmentName" value="" type="text" id="txtBudgetDepartment" class="inputbtnRefViewGray" ></span><input id='btnRefClear' class='btnRefView' title='点击清空参照文本框内容' type='button' value='X'  onclick="cleanDep();"><input id="btntxtYsssbmShow" class='btnRefView' title='点击打开参照文本框内容' type='button' value='…'>
		                        <input name="budgetDepartmentCode" value="" type="hidden" id="txtYsssbm" class="inputbtnRefViewGray" >
	                        </td>
									...
									<div>
										<table style="width:825px;" class="adminlist" cellspacing="0" rules="all" border="1" id="gridDataList" style="border-collapse:collapse;">
											<tr style="white-space:nowrap;">
												...
												<th scope="col" class="tdpadding"><font color="red" >*</font>是否电脑</th>
												...
												<!-- 10 -->
												<th scope="col" class="tdpadding"><font color="red" >*</font>需求数量</th>
												<!-- 15 -->
												<th scope="col" class="tdpadding"><font color="red" >*</font>参考单价</th>
												<th scope="col" class="tdpadding"><font color="red" >*</font>参考总价</th>
												<th scope="col" class="tdpadding"><font color="red" >*</font>要求到位日期</th>
												<!-- 20 -->
											...
											<tr class="bodyTr" style="white-space:nowrap;">
												...
												<td class="tdpadding" id='statusIndex'>1</td>
												<td class="tdpadding">
													<input name="projectCode" type="text" id="txtApplydep1" style='width:130px;' class="inputbtnRefViewGray" readonly="readonly"><input id="projectCodeClear" class="btnRefView" onclick="" title="点击清空参照文本框内容" type="button" value="X"><input id="btnRefShow1" class="btnRefView"  title="点击打开参照文本框内容" type="button" value="…">
												...
												<td class="tdpadding">
	                                    		   <select index="1" disabled='disabled' name="standardComputer" id="txtStandardComputer" style="width: 70px;">
				                                       <option value="">请选择</option>
												...
												<!-- 5 -->
												<td class="tdpadding"><input type="text" name="functions" size='10' id="txtFunctions"></td>
												<td class="tdpadding"><input type="text" name="optionalAccessories" size='10' id="txtOptionalAccessories"></td>
												<td class="tdpadding"><input type="text" name="acceptanceCriteria" size='10' id="txtAcceptanceCriteria"></td>
												<td class="tdpadding"><input type="text" name="avaliableSumMoneyOld" class='rightalign' id="txtAvaliableSumMoney1" size='7' readonly="readonly"></td>
												...
												<td class="tdpadding"><input type="text" name="budgetYear" id="txtBudgetYear1" size='2' readonly></td>
												<!-- 10 -->
												<td class="tdpadding"><input type="text" name="demandCount" class='rightalign' id="txtDemandCount1" size="5"></td>
												<!-- 15 -->
												<td class="tdpadding"><input type="text" name="referenceUnitPrice" class='rightalign' id="txtReferenceUnitPrice1" size="5"></td>
												<td class="tdpadding"><input type="text" name="referencePrice" class='rightalign' id="txtReferencePrice1" size="5"></td>
												<td class="tdpadding"><input readonly='readonly' name="requirementsDate" value="" type="text" id="txtRequirementsDate" class="Wdate" onclick="WdatePicker({skin:'ext'});"></td>
												<!-- 20 -->
												<td class="tdpadding"><input type="text" name="useDescription" id="txtUseDescription"></td>
											</tr>
										</tbody>
											...
											<tr style="white-space:nowrap;">
												...
												<td></td>
												<td></td>
												<td class='tdpadding'><input type="text" class='rightalign' readonly="readonly" name="" id="sumDemandCount" size="5"></td>
												<td></td>
												<td class='tdpadding'><input type="text" class='rightalign' readonly="readonly" name="sumTxtReferencePrice" id="sumTxtReferencePrice" size="5"></td>
												<td></td>
												<td></td>
											</tr>
			...
			<tr>
				...
				<div class="imgtitle"></div>立项书  &nbsp;&nbsp;
					...
					<select id="txtProjectProposal" name="projectProposal">
						...
						<%--<input type="radio" id="txtProjectProposal" name="projectProposal" value="Y">是--%>
						<%--<input type="radio" id="txtProjectProposal" name="projectProposal" value="N" checked="checked">否--%>
					</font>
				</td>
			</tr>
			<tr>
					...
					<table id="Table8" border="0" cellpadding="3px" cellspacing="0" width="100%">
						<tbody>
							<tr>
								...
								<td>
									<input name="entryName" type="text" value="" id="txtEntryName" project="Y">
								</td>
								<td style="text-align: right"><font color="red">*</font>立项金额:</td>
								<td>
									<input name="projectMoney" type="text" value=""  class='rightalign' id="txtProjectMoney" project="Y">
								</td>
								<td style="text-align: right"><font color="red">*</font>项目背景:</td>
								<td>
									<input name="projectBackground" type="text" value="" id="txtProjectBackground" project="Y">
								</td>
							</tr>
							<tr>
								<td style="text-align: right">收益核算方式:</td>
								<td>
									<input name="incomeAccountingMethod" type="text" value="" id="txtIncomeAccountingMethod" project="Y">
								</td>
								<td style="text-align: right">年收益金额:</td>
								<td>
									<input name="annualIncomeAmount" type="text" class='rightalign' value="" id="txtAnnualIncomeAmount" project="Y">
								</td>
								<td style="text-align: right">投资回收期:</td>
								<td>
									<input name="paybackPeriodOfInvestment" type="text" value="" id="txtPaybackPeriodOfInvestment" project="Y">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="5">
									...
									<input type="text" name="projectType" id="txtProjectType" value="" project="Y" size="70" maxlength="100">
								</td>
							</tr>
						</tbody>
					</table>
		...
		<div class="divtitlemt">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td>
						<input type="file" name="multipartFile" id="fileToUpload2" project="Y" class="colorblur" onblur="this.className='colorblur';" onfocus="this.className='colorfocus';">
						<input type="submit" name="btnUpload" value="上传" id="btnUpload2" project="Y" class="btn">
						<input type="submit" name="btnDelFile" value="删除" id="btnDelFile2" project="Y" class="btn"></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="divGrid">
	...
	<div id="budgetWindow" name="" class="easyui-window" title="选择预算" data-options="iconCls:'icon-save'" style="width:750px;height:420px;padding:5px;" closed="true">
		<div class="easyui-layout" data-options="fit:true">
			...
			<form id="budgetForm">
				...
				<td >公司</td>
				<td name=""><input type="text" id="companyName" readonly="readonly" name="companyName"><input type="hidden" id="company" readonly="readonly" name="company"></td>
				<td>成本中心</td>
				...
				<tr style="text-align: left">
				<td>项目</td><td><input type="text" name="projectName" id="projectName"></td><td>年度</td>
				<td>
...
<script type="text/javascript">
	...
	//	根据公司查询 平台
		...
		$.ajax({
			...
			success : function(platformlist) {
				//console.log(platformlist.platform);
				$("#txtPlatform").val(platformlist.platform);
				if(!(platformlist.platform.indexOf("区域")>0 && (platformlist.platform.indexOf("家居")>0 || platformlist.platform.indexOf("商用")>0) )){
	...
	$('#txtAssetType1').change(function(){
		...
		if (assetsType == "IT资产") {
			...
			$("#txtStandardComputer").attr("disabled","disabled");
		}
		...
		$.ajax({
	        ...
	        // dataType: "json",
	         ...
	         success: function(data){
                 ...
                 $("#attachDepartMajordomoCode").val(data.attachDepartMajordomoCode);
                 $("#attachDepartMajordomoName").val(data.attachDepartMajordomoName);
                 $("#attachDepartVpresidentCode").val(data.attachDepartVpresidentCode);
                 $("#attachDepartVpresidentName").val(data.attachDepartVpresidentName);
                 $("#purchasingManagerName").val(data.purchasingManagerName);
                 $("#purchasingManagerCode").val(data.purchasingManagerCode);
	         }
		});
		// 根据平台 查询区域
		$("#txtRegion option").remove();
	...
	$("#budgerSure").click(function(){
		...
		var unitPrice = toDecimal2($("#unitPrice"+i).html());//预算单价
	...
	function addRow() {
		...
		tableHtml += "<td class='budgetAssetsNameTd' style='padding-left: 10px; padding-right: 10px;'><input readonly type='text' name='budgetAssetsName' size='10' id='txtBudgetAssetsName"+statusIndex+"'></td>";
		...
		tableHtml += "<td class='assetsNameTd' style='padding-left: 10px; padding-right: 10px;'><input type='text' name='assetsName' size='10' id='txtAssetsName"+statusIndex+"'></td>";
		tableHtml += "<td class='specificationParameterTd' style='padding-left: 10px; padding-right: 10px;'><input type='text' size='10' name='specificationParameter' id='txtSpecificationParameter'></td>";
		/* 5 */
		...
		tableHtml += "<td class='tdpadding'><input type='text' name='acceptanceCriteria' id='txtAcceptanceCriteria' size='10'size='10'></td>";
	...
	//提交表单
	function saveOrder(strDraft,isMail, isPhoneMessage, idea){
		var obj = {
			 demandOrderId: "",
		     applyUser: "",
		     assetsName: "",
	...
	function showAgreeDialog() {
        var url = "${dynamicURL}/workflow/showAgreeDialog?parentWindowId=add";
	...
	function commitAgree(isMail, isPhoneMessage, idea) {
		...
		//alert(isMail+"---"+isPhoneMessage+"---"+idea);
		saveOrder("N",isMail, isPhoneMessage, idea);
		$("#btnSave").val("提交");
	...
	function sumAll() {
		...
		//数量*单价
		$("input[id^='txtDemandCount']").each(
				function() {
					var c = $(this).val();//数量
					sumDemandCount += c-0;
					var p = $(this).parent().parent().find(
							"input[id^='txtReferenceUnitPrice']").val();//单价
					var s = $(this).parent().parent().find("input[id^='txtReferencePrice']").val();//总价
        ...
        sumReferencePrice = sumReferencePrice.toFixed(2)
		$("#sumTxtReferencePrice").val(sumReferencePrice);
	}
	...
	$("#txtStandardComputer").live('change',function() {
		if ($(this).children('option:selected').val() == "Y") {
			...
			for (var i = 0; i < standardComputerArray.length; i++) {
				assetsNamehtml += "<option value='"+standardComputerArray[i].assetsName+"'>"
						+ standardComputerArray[i].assetsName
						+ "</option>";
			}
