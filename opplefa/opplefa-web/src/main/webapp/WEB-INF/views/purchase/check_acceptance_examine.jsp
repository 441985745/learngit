...
<div id="Div2" style="margin-left: 10px; margin-top: 0px;">
    ...
    <c:choose>
        <c:when test="${checkAcceptance.capprovalstate == '等待审批'}"> </c:when>
        <c:otherwise>
    ...
    <c:if test="${assetAccounting == 'N'}">
        <input type="submit" name="" value="sap订单收货" id="btnSynchronous" class="btn">
    </c:if>
    <c:if test="${isassetAccounting == 'Y' && checkAcceptance.assetsType == 'IT资产' && checkAcceptance.orderType =='ZAB' && isUpdateAssetsFrom == ''}">
        <input type="submit" name="" value="更新成本中心" id="btnUpdateAssetsFromSAP" class="btn">
    </c:if>
</div>
...
<div style="margin-top: 5px;">
    ...
    <div id="receiveGoodsTab" style="width:100%;">
        <div title="验收信息" id="tabsa" style="width:90%; margin: 0 auto;">
            <form action="receiveGoodsHeader" id="receiveGoodsHeaderForm">
                <table id="addReceiveGoodsHeaderTable" border="0" cellpadding="3px" cellspacing="0" width="90%">
                    ...
                    <tr>
                        ...
                        <td class="tdtext">
                            <input name="receiveGoodsId" readonly value="${checkAcceptance.receiveGoodsId }" type="text"
                    ...
                    <tr>
                        ...
                        <td class="tdtext">
                            <input name="useInfo" readonly value="${checkAcceptance.useInfo }" type="text" id="useInfo"
                                   class="colorblur">
                        </td>
                    ...
                    <tr>
                        ...
                        <!-- ? 申请行里的 折旧年限 -->
                        <td class="tdtext">
                            <input name="depreciation" readonly value="${checkAcceptance.depreciation }" type="text"
                    ...
                    <tr>
                        ...
                        <td class="tdtext">
                            <input name="supplierName" readonly value="${checkAcceptance.supplierName }" type="text"
                                                ...
                                                <div>
                                                    <table id="table_add_detail" class="adminlist" cellspacing="0"
                                                        ...
                                                        <tr style="white-space:nowrap;">
                                                            ...
                                                            <th style='display: none' scope="col"><font
                                                                    color="red">*</font>固定资产编码
                                                            </th>
                                                            <!-- MM+sap主编码+sap次级编码 -->
                                                            <th class='tdpadding' scope="col"><font
                                                                    color="red">*</font>资产编号
                                                            ...
                                                            <th class='tdpadding' scope="col"><font
                                                                    color="red">*</font>归口管理编码
                                                            </th>
                                                            <!-- 手动填 -->
                                                            <th class='tdpadding' scope="col"><font
                                                                    color="red">*</font>序列号
                                                            </th>
                                                            <!-- 手动填  checkAcceptance.assetsType-->
                                                        ...
                                                        <c:forEach items="${checkAcceptanceDetaillist }" var="o"
                                                            ...
                                                            <tr class='bodyTr' style="white-space: nowrap;">
                                                                <td>${status.index+1 }
                                                                    <input type="hidden" name="checkAcceptDetailId"
                                                                           value="${o.checkAcceptDetailId}">
                                                                ...
                                                                <td><input type='text' readonly name='epMaterialdocu'
                                                                           id='epMaterialdocu'
                                                                           value='${o.epMaterialdocu}'></td>
                                                                <td><input type='text' readonly name='epBelnr'
                                                                           id='epBelnr'
                                                                           value='${o.epBelnr}'></td>
                                                                <td><input type='text' readonly name='epMatdocumentyear'
                                                                           id='epMatdocumentyear'
                                                                           value='${o.epMatdocumentyear}'></td>

                                                                <td>${o.recWarrantyPeriod}</td>
                                                                <td><input type='hidden' name='storageLocation'
                                                                           value='${o.storageLocation}'>${o.storageLocation}
                                                                </td>
                                                                <td><c:if test="${isManager == 'Y'}">
                                                                    <input name="putUnderManageCode"
                                                                           value="${o.putUnderManageCode}"/>
                                                                </c:if>
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <input name="putUnderManageCode" readonly
                                                                               value="${o.putUnderManageCode}"/>
                                                                    </c:if>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="manufactureFactory"
                                                                                   value="${o.manufactureFactory}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="manufactureFactory"
                                                                ...
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="managementLevel"
                                                                                   value="${o.managementLevel}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="managementLevel" readonly
                                                                                   value="${o.managementLevel}"/>
                                                                        </td>
                                                                    </c:if>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="accuracyClass" readonly
                                                                                   value="${o.accuracyClass}"/></td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="accuracyClass"
                                                                                   value="${o.accuracyClass}"/></td>
                                                                    </c:if>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="verificationCycle" readonly
                                                                                   value="${o.verificationCycle}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="verificationCycle"
                                                                                   value="${o.verificationCycle}"/>
                                                                        </td>
                                                                    </c:if>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="calibrationDate" readonly
                                                                                   value="${o.calibrationDate}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="calibrationDate"
                                                                                   value="${o.calibrationDate}" class='Wdate' onclick='WdatePicker({})'/>
                                                                        </td>
                                                                    </c:if>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="nextCalibrationDate"
                                                                                   readonly
                                                                                   value="${o.nextCalibrationDate}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="nextCalibrationDate"
                                                                                   value="${o.nextCalibrationDate}"  class='Wdate' onclick='WdatePicker({})'/>
                                                                        </td>
                                                                    </c:if>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <c:if test="${isManager == 'N'}">
                                                                        <td><input name="calibrationUnit" readonly
                                                                                   value="${o.calibrationUnit}"/>
                                                                        </td>
                                                                    </c:if>
                                                                    <c:if test="${isManager == 'Y'}">
                                                                        <td><input name="calibrationUnit"
                                                                                   value="${o.calibrationUnit}"/>
                                                                        </td>
                                                                    </c:if>
                                                                </c:if>
                                                                ...
                                                                <c:if test="${checkAcceptance.assetsType == '计量器具'}">
                                                                    <td class='tdpadding' align=center>
                                                                        ...
                                                                        <select value='${o.isThirdReport}'
                                                                                name='isThirdReport'
                                                                                id='isThirdReport'>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                            <select value='${o.isThirdReport}'
                                                                                    disabled name='isThirdReport'
                                                                                    id='isThirdReport'>
                                                                                </c:otherwise>
                                                                                </c:choose>
                                                                                <c:choose>
                                                                ...
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="cpu" readonly
                                                                               value="${o.cpu}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="internalMemory" readonly
                                                                               value="${o.internalMemory}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="hardpan" readonly
                                                                               value="${o.hardpan}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="ipAddress" readonly
                                                                               value="${o.ipAddress}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="joinDomain" readonly
                                                                               value="${o.joinDomain}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="operatingSystem" readonly
                                                                               value="${o.operatingSystem}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="utilitySystem" readonly
                                                                               value="${o.utilitySystem}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="description" readonly
                                                                               value="${o.description}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == 'IT资产'}">
                                                                    <td><input name="dataBase" readonly
                                                                               value="${o.dataBase}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '机器设备'}">
                                                                    <td><input name="shopType" readonly
                                                                               value="${o.shopType}"/></td>
                                                                </c:if>
                                                                <c:if test="${checkAcceptance.assetsType == '行政资产'}">
                                                                    <td><input name="isBuildingContruction" readonly
                                                                               value="${o.isBuildingContruction}"/>
                                                                    </td>
                                                                </c:if>
...
<script type="text/javascript">
    ...
    function showAgreeDialog() {
        var url = "${dynamicURL}/workflow/showAgreeDialog?parentWindowId=checkAcceptApproveDialog&document=${checkAcceptance.cdocument }" + "&typeId=77078";
    ...
    var assetAccountingFlag = '${isassetAccounting}'; //是否资产会计
    var sapFlag1 = false;
    $("#btnAgree").click(function () {
        var flag = false;
        if('${checkAcceptance.assetsType == '计量器具' && isManager == 'Y'}' ) {
            $("input[name='manufactureFactory']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input[name='managementLevel']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input [name='accuracyClass']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input[name='verificationCycle']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input[name='calibrationDate']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input[name='nextCalibrationDate']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
            $("input[name='calibrationUnit']").each(function () {
                if ($(this).val()==null || "" == $(this).val()) {
                    flag = true;
                }
            });
        ...
        var checkAcceptDetailId1 = null;
        $("input[name='checkAcceptDetailId']").each(function () { //任意一个行明细id传到后台，只要已经同步sap了就可以
            checkAcceptDetailId1 = $(this).val();
        });
        if ('Y' == assetAccountingFlag) {
            $.ajax({
                data: {"id": checkAcceptDetailId1},
                dataType: "json",
                type: "post",
                async: false,
                url: "${dynamicURL}/checkAccept/api/searchIsSap",
                success: function (data) {
                    if (data.isSap == 'Y') {//如果已经同步sap
                        sapFlag1 = true;
                    }
                }
            });
    ...
    function commitAgree(isEmail, isPhoneMessage, idea, agreeActivityId) {
        var length = 0;
        $("input[name='putUnderManageCode']").each(function () {
            if ($(this).val() == null || '' == $(this).val()) {
                length += 1;
            }
        });
        if ($("#isManager").val() == 'Y' && length > 0) {
            alert("请填写归口管理编号");
            return;
        }
        $('#btnAgree').val('提交...');
        ...
        var checkAcceptance = {};
        checkAcceptance.cdocument = $("#cdocument").val();
        checkAcceptance.idea = idea;
        checkAcceptance.isEmail = isEmail;
        checkAcceptance.isManager = '${isManager }';
        checkAcceptance.isPhoneMessage = isPhoneMessage;
        checkAcceptance.activityId = agreeActivityId;
        //console.log(checkAcceptance);

        var checkAcceptanceWrapper = {};
        // 	头
        checkAcceptanceWrapper.checkAcceptance = checkAcceptance;
        // 	行
        var objCheckDetail = {
            receiveGoodsId: "", // 收货单号
...
//            managementCode :"", //管理编码
        ...
        for (var i = 0; i < objArrCheckAcceptanceDetail.length; i++) {
            objArrCheckAcceptanceDetail[i].checkAcceptId = $('#cdocument').val();
        }
        ...
        $.ajax({
            ...
            url: "${dynamicURL}/checkAccept/api/agreeCheckAcceptance",
...
//                    dg.curWin.location=dg.curWin.location;;
    ...
    /* 退回 s */
    function commitDeny(isEmail, isPhoneMessage, idea, denyActivityId, denyPhoto) {
        $('#btnDeny').val('提交...');
        ...
        checkAcceptance.isEmail = isEmail;
        checkAcceptance.isPhoneMessage = isPhoneMessage;
        checkAcceptance.activityId = denyActivityId;
        //console.log(checkAcceptance);
        //debugger
        $.ajax({
            type: "POST",
            ...
            async: false,
            contentType: "application/json; charset=utf-8",
            url: "${dynamicURL}/checkAccept/api/denyCheckAcceptance",
            data: JSON.stringify(checkAcceptance),
            success: function (data) {
                if (data.success) {
                    alert("审批成功");
                    dg.curWin.location = dg.curWin.location;
    ...
    function showDenyDialog() {
        var url = "${dynamicURL}/workflow/showDenyDialog?parentWindowId=checkAcceptApproveDialog&document=${checkAcceptance.cdocument }" + "&typeId=77078";
        var dlg = new dg.curWin.$.dialog({
            id: 'denyDialog',
            parent: dg,
            title: '邮件短信提醒',
    ...
    $('#btnDeny').click(function () {
        var isSapFlag = false;
        $("input[name='epMaterialdocu']").each(function () {
            if ("" != $(this).val() && null != $(this).val()) {
                isSapFlag = true;
                return;
            }
        ...
        if (("等待审批" == '${checkAcceptance.capprovalstate}' || "正在审批" == '${checkAcceptance.capprovalstate}') && '${assetAccounting}' != 'Y') {
            showDenyDialog();
        } else {
            alert("只有等待审批和正在审批并且未同步sap的单据能退回");
            return;
        }
    });
    ...
    function showDropDialog() {
        var url = "${dynamicURL}/workflow/showDropDialog?parentWindowId=checkAcceptApproveDialog";
    ...
    $('#btnDrop').click(function () {
        ...
        if ('${assetAccounting}' != 'Y') {
            showDropDialog();
        }
    });
    function commitDrop(isEmail, isPhoneMessage, idea) {
        ...
        $.ajax({
            ...
            async: false,
            contentType: "application/json; charset=utf-8",
            url: "${dynamicURL}/checkAccept/api/dropCheckAcceptance",
            data: JSON.stringify(checkAcceptance),
            success: function (data) {
                if (data.success) {
                    alert("审批成功");
    ...
    var updateAssetsFormSap = false;
    $("#btnUpdateAssetsFromSAP").click(function () {
        if (updateAssetsFormSap) {
            alert("已经更新成功");
            return;
        }
        $("#btnAgree").attr("disabled", true);
        ...
        $("#btnSynchronous").attr("disabled", true);
        var list = [];
        $("input[name='checkAcceptDetailId']").each(function () {
            list.push($(this).val());
        });
        var isSapFlag = false;
        $("input[name='epMaterialdocu']").each(function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            asycn: false,
            contenType: "application/json; chatset=utf-8",
            url: "${dynamicURL}/checkAccept/api/updateAssetsForm",
            data: {"cdocument": $("#cdocument").val(), "list": list},
            success: function (data) {
                if (data.success) {
                    alert("更新成本中心成功");
                    updateAssetsFormSap = true; //更新成本中心成功
                ...
                $("#btnSynchronous").attr("disabled", false);
            }
        })
    ...
    $("#btnSynchronous").click(function () {
        ...
        $.ajax({
            ...
            asycn: false,
            contenType: "application/json; chatset=utf-8",
            url: "${dynamicURL}/checkAccept/api/synchronousSAPAssets",
            data: {"cdocument": $("#cdocument").val(), "list": list},
            success: function (data) {
                if (data.success) {
                    alert("同步sap资产信息成功");
                    updateAssetsFormSap = true; //更新成本中心成功
                    $("input[name='epMaterialdocu']").each(function () {
                        $(this).val(data.result.epMaterialdocu);
                    });
                    $("input[name='epBelnr']").each(function () {
                        $(this).val(data.result.epBelnr);
                    });
                    $("input[name='epMatdocumentyear']").each(function () {
                        $(this).val(data.result.epMatdocumentyear);
                    });
                } else {
                    alert(data.errorMessages.join());
