...
<script type="text/javascript">
    ...
    function EasyWindow() {
        ...
        var initEasyWindow = function (title, fileName, uploadUrl, callback) {
//            console.log(title);
            this._title = title;
            ...
            $downloadBtn.click(function () {
                //fileName = "asset_unit.xlsx";
                var downloadUrl = "${dynamicURL}/download/downLoadFile?downloadFileName=" + encodeURIComponent(that._fileName);
