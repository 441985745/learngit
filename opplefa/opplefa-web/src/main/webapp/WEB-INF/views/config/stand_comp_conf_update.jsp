                    ...
                    <form id = "updateForm">
                        <table border="0" cellspacing="0" cellpadding="0" id="format">
                            ...
                            <tr>
                                ...
                                <td><input name="assetsCode" type="text" value="${assets.assetsCode}" class="colorblur require-red" readonly/> </td>
                            </tr>
                            <tr>
                                <td class="tdtitle"><span>*</span>资产名称:</td>
                                <td><input name="assetsName" type="text" value="${assets.assetsName}" class="colorblur require-red"/></td>
                            </tr>
                            <tr>
                                <td class="tdtitle"><span>*</span>规格参数:</td>
                                <td><input name="specificationParameter" type="text" value="${assets.specificationParameter}" class="colorblur require-red"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea cols="50" rows="3" name="cmemo" id="cmemo" class="colorblur code">${assets.cmemo}</textarea>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSave").click(function () {//保存
            update(dg, this, '${dynamicURL}/config/standCompConf/update');
        });
    });
