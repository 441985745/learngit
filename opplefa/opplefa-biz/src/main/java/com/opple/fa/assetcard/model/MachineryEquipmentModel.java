...
@Data
public class MachineryEquipmentModel {
	private Integer id;
	...
	private Date dateOfAcceptance; // 计划收日期
	...
	private String periodOfDepreciation; // 折旧年限（月）
	private String currentYearNoDepreciation; // 当年未计提折旧
	private String monthCountingDepreciation; // 本月计提折旧
	private String currentYearDepreciation; // 当年已计提折旧金额
	...
	private String currentYearMonths; // 当年累计折旧月数
